# Extraction run — careful-freeform-repair

- provider: `mock` · model: `mock-1`
- prompt: `careful` · output mode: `freeform` · max attempts: 3 · grounding repair: True
...
| rescued by the repair loop | 3 documents |
| mean repair round-trips | 1.04 |
...
| metric | value |
| --- | --- |
| overall field accuracy | 84.4% |
| accuracy on fields that have a value | 85.9% |
| **hallucination rate** (invented a value where the document has none) | 23.5% |
...
| `bait:absent_years` | 10 | 82.0% | 11 | 0 |
